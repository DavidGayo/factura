...
use Usuario\UserBundle\Entity\perfil;
use Usuario\UserBundle\Form\perfilType;
...
class perfilController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        if($usuario->getPerfil()){
            ...
            return $this->redirect($this->generateUrl('perfil_show', array('id' =>$perfil->getId() )));
        }

        return $this->redirect($this->generateUrl('perfil_new'));
    }
    /**
    ...
    public function newAction()
    {
        ...
        if($usuario->getPerfil()){
            return $this->redirect($this->generateUrl('perfil_show', array('id' => $usuario->getPerfil())));
        }
        $entity = new perfil();
        $form   = $this->createCreateForm($entity);
