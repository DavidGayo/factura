...
use Usuario\UserBundle\Entity\User;
use Usuario\UserBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function listadoAction()
    {
        ...
        return $this->render('UserBundle:User:listado.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function perfilAction()
    {
        ...
        return $this->render('UserBundle:User:perfil.html.twig', array(
            'usuario' => $usuario,
        ));
    }
    /**
