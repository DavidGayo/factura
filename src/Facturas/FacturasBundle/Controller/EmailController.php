...
use Facturas\FacturasBundle\Entity\Email;
use Facturas\FacturasBundle\Form\EmailType;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FacturasBundle:Email')->findAll();

        return $this->render('FacturasBundle:Email:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FacturasBundle:Email:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FacturasBundle:Email')->find($id);
        ...
        return $this->render('FacturasBundle:Email:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FacturasBundle:Email:edit.html.twig', array(
            'entity'      => $entity,
