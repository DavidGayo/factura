...
use Facturas\GeneralBundle\Entity\TipoProducto;
use Facturas\GeneralBundle\Form\TipoProductoType;
...
class TipoProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GeneralBundle:TipoProducto')->findAll();

        return $this->render('GeneralBundle:TipoProducto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GeneralBundle:TipoProducto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GeneralBundle:TipoProducto')->find($id);
        ...
        return $this->render('GeneralBundle:TipoProducto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GeneralBundle:TipoProducto:edit.html.twig', array(
            'entity'      => $entity,
